...
namespace Textadventure
{
    internal class VillageQuest1
    {
        ...
        private static Scene[] _scenes = {
            ...
            }, "DORF_QUEST1", "Eine junge Frau kommt auf dich zu. Sie scheint sehr besorgt:" + nl + "Bitte, ihr seid doch ein Abenteurer, mein Sohn ist verschwunden und ich kann ihn nicht finden!", "$villageQuest1"),
            new Scene(new Option[]
            {   new Option("village_search", OptionIdentifier.SEARCH, "Als du hinter den Fässern schaust, findest du #den vermissten Jungen. Du bringst ihn zu seiner Mutter. #einige Ratten, die ein Bankett mit Tee und diversen Gerichten halten. Die Ratten sind von deinem Verhalten empört und bitten dich höflich zu gehen.", new string[]{"DORF_QUEST1_END", "DORF_QUEST1_SUCHE"}, new string[]{"Fässer", "Fässern", "Fass", "Rumpern"}, VisibilityCondition.ONCE),
                new Option("village_search", OptionIdentifier.OPEN, "Als du in die Fässer schaust, siehst du #den vermissten Jungen. Nachdem du ihn aus einem nassen Fass ziehst bringst du den Jungen zu seiner Mutter. #nur Wein, Obst und Gemüse.", new string[]{"DORF_QUEST1_END", "DORF_QUEST1_SUCHE"}, new string[]{"Fässer", "Fässern", "Fass", "Rumpern"}, VisibilityCondition.ONCE),
                new Option("village_search", OptionIdentifier.SEARCH, "Als du dich in der Schmiede umschaust, findest du #den vermissten Jungen, welcher mit den Hämmern und Zangen spielt. Nachdem du ihm die Schmiedewerkzeuge abgenommen hast bringst du den Jungen zu seiner Mutter. #einige Vögel, welche sich im Innendach der Schmiede ein Nest gebaut haben. Sie scheinen kein Problem darzustellen.", new string[]{"DORF_QUEST1_END", "DORF_QUEST1_SUCHE" }, new string[]{"Schmied", "Schmiede", "metallene", "Metall", "Klänge"}, VisibilityCondition.ONCE)
