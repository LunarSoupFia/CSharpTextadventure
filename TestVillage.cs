...
namespace Textadventure
{
    internal static class TestVillage
    {
        ...
        private static Scene[] _scenes = {
            ...
            }, "DORF_TAVERNE1","Du betrittst eine Taverne, in der das Leben pulsiert. An vielen Tischen lassen sich Gruppen von Trinkliebhabern und Glückspielfreunden sehen. Du setzt dich an den Thresen, wo dich der Wirt begrüßt:" + nl + "Na, was darf es sein?", "$tavern"),
            new Scene(new Option[]{
