    ...
    internal static class Village
    {
        ...
        private static Scene[] _scenes = {
            new Scene(new Option[]{
                ...
                new Option(OptionIdentifier.GO, "Du besuchst den alten Mann am Rand des Dorfs.", new string[]{"DORF_OLD_MAN1"}, new string[]{"Mann", "Greis", "alter", "altem", "alten"}),
